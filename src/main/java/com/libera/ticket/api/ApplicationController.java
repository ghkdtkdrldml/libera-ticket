...
public class ApplicationController {
    ...
    @GetMapping("/rsvp") public String rsvp(){ return "rsvp"; }
    ...
    // API
    @GetMapping("/api/performers") @ResponseBody
    public List<Performer> performers(){ return performerRepo.findAll(); }

    @PostMapping("/api/applications") @ResponseBody
    public CreateApplicationRes create(@RequestBody CreateApplicationReq req){
        return service.create(req);
    }

    @PostMapping("/api/cancel/{token}") @ResponseBody
    ...
    // CSV Export
    @GetMapping(value="/api/export/csv", produces="text/csv") @ResponseBody
